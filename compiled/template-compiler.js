...
module.exports = function(template, theme) {
  ...
  return function(h) {
    var modules = {
      ...
      dropdownPagination: require("./modules/dropdown-pagination").call(
        this,
        h
      ),
    ...
    if (
      ...
      (!templates[template] || typeof templates[template] !== "function")
    ) {
    ...
    if (
      typeof theme === "string" &&
      (!themes[theme] || _typeof(themes[theme]) !== "object")
    ) {
